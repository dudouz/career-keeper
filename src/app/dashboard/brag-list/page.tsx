...
export default function BragListPage() {
  ...
  const loadContributions = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // The GET endpoint returns { contributions, lastScanned, scanCount }
        setContributions(data.contributions)
      } else {
        console.error("Failed to load contributions:", response.status, response.statusText)
      }
    } catch (error) {
